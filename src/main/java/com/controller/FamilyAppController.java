...
public class FamilyAppController {
    ...
    public Map<Object, Object> getContractContent(@RequestBody Map<Object, Object> requests) {
        Map<Object, Object> result = new HashMap<>();
        Map<Object, Object> contractContent = familyAppService.getContractContent(((Number) requests.get("familyId")).longValue());
        if (null != contractContent && (int) requests.get("status") == 1) {
    ...
    public Map<Object, Object> getCase(@RequestBody Map<Object, Object> requests) {
        Map<Object, Object> result = new HashMap<>();
        Map<String, Object> cases = caseService.getCaseByCaseId(((Number) requests.get("caseId")).longValue());
    ...
    public Map<Object, Object> getAllHealthKnowledge(@RequestBody Map<Object, Object> requests) {
        Map<Object, Object> result = new HashMap<>();
        List<HealthKnowledge> list = familyAppService.getAllHealthKnowledge((String) requests.get("title"));
        if (null != list && (int) requests.get("status") == 1) {
    ...
    @ResponseBody
    @PostMapping("/getServiceRecordList")
    public Map<Object, Object> getServiceRecordList(@RequestBody Map<Object, Object> requests) {
        Map<Object, Object> result = new HashMap<>();
        List<Map<Object, Object>> list = serviceRecordService.getServiceRecordList(((Number) requests.get("familyId")).longValue());
        if (null != list && (int) requests.get("status") == 1) {
            result.put("ServiceRecord", list);
            result.put("status", 1);
            return result;
        }
        result.put("status", 0);
